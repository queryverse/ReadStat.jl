...
products_readstat = [
ExecutableProduct(prefix, "/home/travis/build/davidanthoff/ReadStatBuilder/bin/readstat"),
...
if platform_key() in keys(download_info)
    ...
    if any(!satisfied(p; verbose=true) for p in products_readstat)
    ...
    # variable, etc...)
    @write_deps_file products_readstat[2]
else
